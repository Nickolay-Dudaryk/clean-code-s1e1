...
var taskInput=document.querySelector(".new-task__name");//Add a new task.
...
var addTask=function(){
    ...
    //Create a new list item with the text from the .new-task__name:
...
//select ListItems children
    var checkBox=taskListItem.querySelector(".task-list__item__checkbox");
